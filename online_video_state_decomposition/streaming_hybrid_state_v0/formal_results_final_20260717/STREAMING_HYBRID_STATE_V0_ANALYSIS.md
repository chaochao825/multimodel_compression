...
| 15 | 0.50 | residual_pq | pq_0p5b_k16_d8@1.00 | 0.721 | 0.7704 | 0.4303 |
...
| 15 | 4.00 | scalar_quant | int4 | 4.016 | 0.9038 | 0.2038 |
| 22 | 0.50 | raw_pq | pq_0p5b_k16_d8 | 0.501 | 0.6105 | 0.6266 |
| 22 | 0.50 | residual_pq | pq_0p5b_k16_d8@1.00 | 0.721 | 0.7390 | 0.4842 |
...
| 15 | 1.58 | 0.553 | 0.542 | -0.200 | False |
| 15 | 2.00 | 0.597 | 0.434 | -0.227 | False |
| 15 | 4.00 | 0.581 | 0.395 | -0.240 | False |
| 22 | 0.50 | 0.451 | 0.419 | +0.000 | False |
| 22 | 1.00 | 0.626 | 0.467 | -0.027 | False |
| 22 | 1.58 | 0.567 | 0.494 | -0.520 | False |
| 22 | 2.00 | 0.620 | 0.539 | -0.013 | False |
...
| 22 | 2.00 | dlgn | 0.9551 | 2.048 | 0.206 | 0.606 | 0.812 | 0.188 | 0.358 | False | False |
...
The next experiment should connect the qualified 2-bit/4-bit policy to a task-level streaming benchmark and first reduce the true encoder-required rate. RTL work is justified only after that gate.
