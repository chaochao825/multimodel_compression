...
| claim_boundary_explicit | FAIL | major | summary separates representation quality from task/PPA claims |
| no_unsupported_positive_claim | PASS | major | unsupported phrases: [] |

## Major Issues

- claim_boundary_explicit: summary separates representation quality from task/PPA claims
