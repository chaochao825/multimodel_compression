...
samples_per_task="$6"
pool_grid="${7:-8}"
policies="${8:-exact_recent,recent_pool_query_topk,recent_pool_query_mmr,learned_recent_query_topk}"
...
flock -n "${lock_path}" python -u \
  "${project_root}/experiments/probes/mvbench_llava_feature_memory_anchor.py" \
