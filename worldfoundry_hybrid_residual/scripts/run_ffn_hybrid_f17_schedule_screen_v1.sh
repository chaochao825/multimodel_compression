...
OUT="$PROBE_ROOT/results/worldfoundry_ffn_hybrid_f17_schedule_screen_v1"
...
"$BASE_ROOT/.venv/bin/python" "$PROBE_ROOT/scripts/generate_wan_hybrid_residual.py" \
  ...
  --methods dense,fp8,hybrid_middle1,hybrid_middle2,hybrid_middle4,hybrid_middle8,hybrid_refresh2,hybrid_refresh3,hybrid_refresh4 \
