...
OUT="$PROBE_ROOT/results/worldfoundry_ffn_hybrid_f17_multiseed_v2"
...
"$BASE_ROOT/.venv/bin/python" "$PROBE_ROOT/scripts/generate_wan_hybrid_residual.py" \
  ...
  --methods dense,dense_cache007,dense_cache008,fp8,fp8_middle1,hybrid_middle1,hybrid_middle1_cache007,hybrid_middle1_cache008 \
...
"$BASE_ROOT/.venv/bin/python" "$PROBE_ROOT/scripts/summarize_hybrid_residual.py" \
  ...
  --dense-cache-method dense_cache007 \
  --primary-method hybrid_middle1 \
  --primary-cache-method hybrid_middle1_cache007 \
