...
OUT="$PROBE_ROOT/results/worldfoundry_ffn_hybrid_f17_schedule_screen_v2"
...
"$BASE_ROOT/.venv/bin/python" "$PROBE_ROOT/scripts/generate_wan_hybrid_residual.py" \
  ...
  --max-prompts 1 --seeds 20260723 \
  --methods dense,fp8_middle1,hybrid_middle1,hybrid_middle2,hybrid_middle4,hybrid_middle8,hybrid_refresh2,hybrid_refresh3,hybrid_refresh4 \
...
"$BASE_ROOT/.venv/bin/python" "$PROBE_ROOT/scripts/summarize_hybrid_residual.py" \
  ...
  --primary-cache-method hybrid_middle1_cache008 \
